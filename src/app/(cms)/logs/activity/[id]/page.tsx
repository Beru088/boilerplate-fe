...
const ActivityLogDetailPage = () => {
  ...
  const { objectChangeLog, objectChangeLogLoading, objectChangeLogFetched, objectChangeLogError, refetch } =
  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <p className='text-muted-foreground'>Detailed view of object changes for activity log #{activityLogId}</p>
      </div>
        ...
        {objectChangeLogLoading ? (
          ...
          <Alert variant='destructive'>
            ...
            <AlertDescription className='flex items-center justify-between'>
              <span>Failed to load object changes. Please try again.</span>
          ...
          <div className='py-8 text-center'>
            <p className='text-muted-foreground'>Loading object changes...</p>
          </div>
        ) : !objectChangeLog || objectChangeLog.length === 0 ? (
          <div className='py-8 text-center'>
            <Activity className='text-muted-foreground mx-auto mb-4 h-12 w-12' />
            <p className='text-muted-foreground'>No object changes found</p>
            <p className='text-muted-foreground mt-2 text-sm'>
              This activity log doesn't have any associated object changes
            </p>
          </div>
        ) : (
